$( function() {
    ...
    var tab1 	 = $('.model-white__tab_1');
        ...
        //form
            ...
            $(".form__field_digits").mask("+7(999) 999-99-99");

            document.querySelector(".form__field_digits").onkeypress= function(event){
            ...
            document.querySelector(".form__field_digits-2").onkeypress= function(event){
                event= event || window.event;
                if (event.charCode && (event.charCode < 48 || event.charCode > 57))// проверка на event.charCode - чтобы пользователь мог нажать backspace, enter, стрелочку назад...
                return false;
            };
            ...
            $('.header__call , .title__btn , .logo , .effect__btn , .need__btn').click(function (e) {
                e.preventDefault();
